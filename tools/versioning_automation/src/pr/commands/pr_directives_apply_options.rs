//! tools/versioning_automation/src/pr/commands/pr_directives_apply_options.rs
use crate::pr::{DirectiveRecordType, State};

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct PrDirectivesApplyOptions {
    pub(crate) text: String,
}

impl PrDirectivesApplyOptions {
    pub(crate) fn run_directives_apply(self) -> i32 {
        let state = State::build_state(&self.text);
