...
pub(crate) struct IssueClosePolicyOutcome {
    pub(crate) kind: String,
    pub(crate) reason: String,
}

pub(crate) fn decide_close_policy(opts: PrIssueClosePolicyOptions) -> IssueClosePolicyOutcome {
    if opts.action != "Closes" {
        return IssueClosePolicyOutcome {
