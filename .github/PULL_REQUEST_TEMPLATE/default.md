...
This pull request merges the `<head-branch>` branch into `<base-branch>` and summarizes merged pull requests and resolved issues.

<!-- Invariant: keep this sentence structure aligned with the generator script. -->

### Scope

<!-- Define what is explicitly in scope for this PR. -->
