...
- [issue_parent_autolink.md](issue_parent_autolink.md): Auto-linking child issues to parents from normalized `Parent:` field.
- [parent_issue_guard.md](parent_issue_guard.md): Parent/child issue status guard and closure policy automation.
