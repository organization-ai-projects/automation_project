...
For detailed descriptions of the core components (`engine`, `central_ui`, `watcher`, `launcher`) and products, refer to [Produits et Composants de l'Espace de Travail](projects/projects_products.md).
...
## 6. Registre (source of truth)

### 6.1 Role

The central registry (`.automation_project/registry.json`) is the source of truth for (see [Registre](registry.md)):
...
For details on initial products like `varina`, refer to [Produits et Composants de l'Espace de Travail](projects/projects_products.md).
