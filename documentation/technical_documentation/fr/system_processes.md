...
Ce document explains how the core system processes are launched, supervised, and coordinated in the `automation_project`.
...
- Ensure the registry is available (`.automation_project/registry.json`). See [Registre](registry.md).
