...
To automate add + commit + push, use the `add_commit_push.sh` script. Replace
`<commit message>` with your actual commit message:

```bash
./scripts/versioning/file_versioning/git/add_commit_push.sh "<commit message>"
```

See the script documentation for details: [Script: add_commit_push.sh](scripts/add_commit_push.md).
