# Table des matieres techniques (FR)
...
- [Documentation automatisee](documentation.md) : objectifs et fonctionnement de la documentation automatisee
- [Convention de nommage des branches](branch_naming_convention.md) : regles de nommage des branches du repository
- [Politique des footers de commit](commit_footer_policy.md) : regles d'usage des footers de fermeture et liaison d'issues
...
- [Retour a l'index documentation](../TOC.md)
