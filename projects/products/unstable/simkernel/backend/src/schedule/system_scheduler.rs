...
impl SystemScheduler {
    ...
    pub fn run_stage(&self, stage: SystemStage, world: &mut World, clock: &LogicalClock, event_log: &mut EventLog) {
    ...
    pub fn run_tick(&self, world: &mut World, clock: &LogicalClock, event_log: &mut EventLog) {
        for stage in [SystemStage::PreTick, SystemStage::Tick, SystemStage::PostTick] {
