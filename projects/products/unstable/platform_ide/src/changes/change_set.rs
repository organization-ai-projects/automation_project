// projects/products/unstable/platform_ide/src/changes/change_set.rs
...
pub struct PatchEntry {
    ...
    /// The full new content for this file (base-64 encoded when serialized).
...
/// Serde module for base-64 encoding of byte vectors.
mod base64_bytes {
    ...
    where
        S: Serializer,
    {
        // Simple base-64 encoding without external dep: use standard hex encoding.
