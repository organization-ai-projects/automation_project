// projects/products/unstable/platform_ide/src/diff/local_diff.rs
...
impl LocalDiff {
    ...
    ///
    /// The diff uses a simple Myers-style longest-common-subsequence (LCS)
    /// approach restricted to lines. Context lines are included to aid
    /// readability. This is sufficient for the IDE's local diff view; the
    /// authoritative diff is computed server-side by the platform.
...
/// Computes a line diff using the longest-common-subsequence algorithm.
