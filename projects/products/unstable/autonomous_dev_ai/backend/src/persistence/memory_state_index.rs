...
/// Index snapshot of the memory state — written alongside the full state
/// for fast introspection without deserializing the full graph.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MemoryStateIndex {
    /// Unix timestamp in seconds when this index was generated.
