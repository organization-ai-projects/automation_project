...
use crate::{
    models::{DecisionEntry, infer_decision_action},
    persistence::utils,
};
...
pub struct DecisionInvertedIndex {
    ...
    pub by_action: collections::HashMap<String, usize>,
    pub by_iteration: collections::HashMap<usize, usize>,
    pub latest_decision_iteration: Option<usize>,
}

impl DecisionInvertedIndex {
    pub fn from_decisions(decisions: &[DecisionEntry]) -> Self {
        let mut by_action = collections::HashMap::new();
        let mut by_iteration = collections::HashMap::new();
