...
fn golden_diamond_dag_layered_svg() {
    ...
    assert_eq!(svg.trim(), golden.trim(), "diamond DAG layered SVG mismatch");
}
...
fn golden_linear_chain_layered_svg() {
    ...
    assert_eq!(svg.trim(), golden.trim(), "linear chain layered SVG mismatch");
}
...
fn golden_single_node_layered_svg() {
    ...
    assert_eq!(svg.trim(), golden.trim(), "single node layered SVG mismatch");
}
