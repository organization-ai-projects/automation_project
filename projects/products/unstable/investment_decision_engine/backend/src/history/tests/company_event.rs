...
fn new_creates_event() {
    let event = CompanyEvent::new("2025-01-15", EventCategory::Earnings, "Q4 Earnings", "Beat estimates");
...
fn serialization_roundtrip() {
    let event = CompanyEvent::new("2025-01-15", EventCategory::Acquisition, "Merged with XYZ", "Strategic expansion");
