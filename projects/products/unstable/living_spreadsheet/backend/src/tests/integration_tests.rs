...
mod tests {
    ...
    fn basic_sheet_values_and_formulas() {
        ...
        engine
            .set_value(a1.clone(), CellValue::Number(3.0))
            .unwrap();
        engine
            .set_value(b1.clone(), CellValue::Number(4.0))
            .unwrap();
        engine
            .set_formula(c1.clone(), "=A1+B1".to_string())
            .unwrap();
    ...
    fn recompute_from_only_affected() {
        ...
        engine
            .set_value(a1.clone(), CellValue::Number(1.0))
            .unwrap();
        engine
            .set_value(b1.clone(), CellValue::Number(2.0))
            .unwrap();
        engine
            .set_formula(c1.clone(), "=A1+B1".to_string())
            .unwrap();
        ...
        engine
            .set_value(a1.clone(), CellValue::Number(10.0))
            .unwrap();
    ...
    fn sum_formula_integration() {
        let mut engine = RecomputeEngine::new(seed());
        engine
            .set_value(CellId::from_a1("A1").unwrap(), CellValue::Number(10.0))
            .unwrap();
        engine
            .set_value(CellId::from_a1("A2").unwrap(), CellValue::Number(20.0))
            .unwrap();
        engine
            .set_value(CellId::from_a1("A3").unwrap(), CellValue::Number(30.0))
            .unwrap();
        engine
            .set_formula(CellId::from_a1("A4").unwrap(), "=SUM(A1:A3)".to_string())
            .unwrap();
        engine.recompute_all().unwrap();
        assert_eq!(
            engine.get_value(&CellId::from_a1("A4").unwrap()),
    ...
    fn event_log_records_recomputed_cells() {
        let mut engine = RecomputeEngine::new(seed());
        engine
            .set_value(CellId::from_a1("A1").unwrap(), CellValue::Number(1.0))
            .unwrap();
        engine
            .set_formula(CellId::from_a1("B1").unwrap(), "=A1*2".to_string())
            .unwrap();
        engine.recompute_all().unwrap();
