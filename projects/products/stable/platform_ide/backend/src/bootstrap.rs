//! projects/products/stable/platform_ide/backend/src/bootstrap.rs
use crate::app::{IdeApp, IdeConfig};
use crate::auth::Session;
use crate::changes::{ChangeSet, PatchEntry};
...
pub(crate) fn run_local_bootstrap(config: &IdeConfig) -> Result<(), IdeError> {
...
pub(crate) async fn run_remote_bootstrap(config: &IdeConfig) {
