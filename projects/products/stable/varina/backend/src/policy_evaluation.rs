...
pub fn is_relevant(path: &str, policy: &AutopilotPolicy) -> bool {
    let compiled = CompiledAutopilotPolicy {
        relevant_prefixes_norm: vec![
            "src/".to_string(),
            "tests/".to_string(),
            "projects/libraries/layers/orchestration/ai/".to_string(),
            "projects/libraries/core/foundation/command_runner/".to_string(),
            "projects/libraries/core/foundation/common/".to_string(),
            ...
            "projects/libraries/layers/domain/neural/".to_string(),
            "projects/libraries/core/contracts/protocol/".to_string(),
            "projects/libraries/layers/domain/security/".to_string(),
            "projects/libraries/layers/domain/symbolic/".to_string(),
            "projects/libraries/layers/domain/ui/".to_string(),
