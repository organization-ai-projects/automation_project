...
```rust
use common_json::{to_json, to_string, to_string_pretty, to_bytes, JsonSerializable, JsonAccess};
use serde::Serialize;
...
assert_eq!(json.get_field("name").expect("Missing 'name'").as_str(), Some("my-app"));
