# Accès fluide aux valeurs JSON et builders
...
## Modification des valeurs JSON

Le trait `JsonAccessMut` permet de modifier des objets et tableaux JSON directement.

### Méthodes principales

| Méthode         | Description                                                    |
| --------------- | -------------------------------------------------------------- |
| `get_field_mut` | Accède à un champ mutable d'objet JSON                         |
| `get_index_mut` | Accède à un élément mutable de tableau JSON                    |
| `set_field`     | Définit ou met à jour un champ d'objet JSON                    |
| `remove_field`  | Supprime un champ d'objet JSON                                 |
| `push`          | Ajoute un élément à un tableau JSON                            |
| `insert_at`     | Insère un élément à un index spécifique dans un tableau JSON   |
| `remove_at`     | Supprime un élément à un index spécifique dans un tableau JSON |
