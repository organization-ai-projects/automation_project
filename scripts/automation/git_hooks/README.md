...
├── branch-creation-check (generated by install_hooks.sh) # Delegates branch/worktree guard to Rust CLI
...
- `branch-creation-check`: Generated by `install_hooks.sh`; delegates branch/worktree guard logic to `versioning_automation git branch-creation-check`.
