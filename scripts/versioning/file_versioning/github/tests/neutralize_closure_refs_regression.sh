...
NEUTRALIZER="${ROOT_DIR}/scripts/versioning/file_versioning/github/issues/neutralize_non_compliant_closure_refs.sh"
REEVALUATOR="${ROOT_DIR}/scripts/versioning/file_versioning/github/issues/reevaluate_prs_on_issue_edit.sh"
