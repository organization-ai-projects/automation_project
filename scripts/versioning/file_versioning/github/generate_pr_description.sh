...
source "${SCRIPT_DIR}/pr/pr_cli.sh"
source "${SCRIPT_DIR}/pr/pr_args.sh"
source "${SCRIPT_DIR}/pr/pr_extraction.sh"
source "${SCRIPT_DIR}/pr/pr_compare.sh"
source "${SCRIPT_DIR}/pr/pr_footprint.sh"
source "${SCRIPT_DIR}/lib/issue_refs.sh"
source "${SCRIPT_DIR}/lib/issue_required_fields.sh"
source "${SCRIPT_DIR}/pr/pr_issue_flow.sh"
