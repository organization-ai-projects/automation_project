...
source "${SCRIPT_DIR}/lib/pr_cli.sh"
source "${SCRIPT_DIR}/lib/pr_args.sh"
source "${SCRIPT_DIR}/lib/pr_extraction.sh"
source "${SCRIPT_DIR}/lib/pr_compare.sh"
source "${SCRIPT_DIR}/lib/pr_footprint.sh"
source "${SCRIPT_DIR}/lib/issue_refs.sh"
source "${SCRIPT_DIR}/lib/issue_required_fields.sh"
source "${SCRIPT_DIR}/lib/pr_issue_flow.sh"
source "${SCRIPT_DIR}/lib/pr_metrics.sh"
source "${SCRIPT_DIR}/lib/pr_runtime.sh"
source "${SCRIPT_DIR}/lib/pr_validation_gate.sh"
source "${SCRIPT_DIR}/lib/pr_pipeline.sh"
