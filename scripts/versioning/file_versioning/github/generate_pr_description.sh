...
source "${SCRIPT_DIR}/lib/pr/pr_cli.sh"
source "${SCRIPT_DIR}/lib/pr/pr_args.sh"
source "${SCRIPT_DIR}/lib/pr/pr_extraction.sh"
source "${SCRIPT_DIR}/lib/pr/pr_compare.sh"
source "${SCRIPT_DIR}/lib/pr/pr_footprint.sh"
source "${SCRIPT_DIR}/lib/issue_refs.sh"
source "${SCRIPT_DIR}/lib/issue_required_fields.sh"
source "${SCRIPT_DIR}/lib/pr/pr_issue_flow.sh"
source "${SCRIPT_DIR}/lib/pr/pr_metrics.sh"
source "${SCRIPT_DIR}/lib/pr/pr_runtime.sh"
source "${SCRIPT_DIR}/lib/pr/pr_validation_gate.sh"
source "${SCRIPT_DIR}/lib/pr/pr_pipeline.sh"
