...
This directory is responsible for providing automation infrastructure and reusable utility libraries for the entire project.
...
2. **Find the right domain** - Does it belong in automation or as a utility library in common_lib?
